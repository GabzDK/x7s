...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        XXXXXXX,      XXXXXXX,      LT(3,KC_ESC), LT(2,KC_TAB), LT(1,KC_SPC),  /*||*/  LT(5,KC_ENT), LT(4,KC_BSPC), LT(6,KC_DEL), XXXXXXX,       XXXXXXX
    ),
    [1] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_NO,   KC_ENT,  KC_BSPC, /*||*/  KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [2] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_NO,   KC_BTN2, KC_BTN1, /*||*/  KC_BTN3, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [3] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_NO,   KC_MSTP, KC_MPLY, /*||*/  KC_MUTE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [4] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_DOT,  KC_0,    KC_MINS, /*||*/  KC_NO,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [5] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, KC_UNDS, /*||*/  KC_NO,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [6] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, KC_APP,  KC_SPC,  KC_TAB,  /*||*/  KC_NO,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    )
};
